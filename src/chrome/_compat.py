...
class Chrome():
    ...
    def options(self, i=None, proxy=False, headless=False, browser_profile=None, proxy_address=None):
        ...
        if not headless:
            chrome_options.add_extension(os.path.abspath("src/chrome/extensions/always_active.zip"))
            chrome_options.add_extension(os.path.abspath("src/chrome/extensions/fingerprint_defender.zip"))
            chrome_options.add_extension(os.path.abspath("src/chrome/extensions/spoof_timezone.zip"))
            chrome_options.add_extension(os.path.abspath("src/chrome/extensions/webrtc_control.zip"))
